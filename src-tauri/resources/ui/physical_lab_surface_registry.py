...
SURFACES: tuple[Surface, ...] = (
    ...
    _s("kerr-geodesics", "Kerr Geodesic Dynamics", "Experiments & Physics",
       ...
       launch_mode="profile", profiles=("nonlinear-chaos", "kerr-geodesics"), route_hint="Kerr Geodesics first-class Lab or legacy Nonlinear Chaos → Engineering"),
    ...
    _s("kerr-shadow", "Kerr Shadow Morphology", "Experiments & Physics",
       ...
       launch_mode="profile", profiles=("nonlinear-chaos", "kerr-geodesics"), route_hint="Kerr Geodesics first-class Lab or legacy Nonlinear Chaos → Deep Science"),
    _s("solar-system", "Sun–Jupiter–Saturn Dynamics", "Experiments & Physics",
       "Solar-system dynamics, direct analysis/V&V, campaign tools and first-class workshop routing.", "physical_lab_solar_system_ui", "render_solar_system_workspace",
       launch_mode="profile", profiles=("nonlinear-chaos", "solar-system-dynamics"), route_hint="Sun–Jupiter–Saturn first-class Lab or legacy Nonlinear Chaos → Engineering"),
    _s("lattice-dynamics", "Multilayer Honeycomb Lattice", "Experiments & Physics",
       ...
       launch_mode="profile", profiles=("oscillation-integration", "honeycomb-lattice"), route_hint="Honeycomb Lattice first-class Lab or legacy Oscillation Integration → Engineering"),
